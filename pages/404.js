...
const FourZeroFour = () => {
  ...
  <div className="flex flex-col items-center justify-center space-y-4 md:mt-24 md:flex-row md:space-x-6">
    ...
    <div className="flex flex-col items-center justify-center max-w-md">
      ...
      <Link href="/">
        <button 
          className="inline rounded-lg border border-transparent bg-secondary-600 px-4 py-2 text-sm font-medium leading-5 text-white shadow transition-colors duration-150 hover:bg-blue-700 focus:outline-none focus:shadow-outline-blue">
          Back to homepage
        </button>
      </Link>
    </div>
